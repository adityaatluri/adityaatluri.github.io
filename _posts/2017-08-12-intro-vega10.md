...
| ---- | ---|
| `v_pk_mad_i16 dst, src0, src1, src2` | dst[31:16] = src0.i[31:16] * src1.i[31:16] + src2.i[31:16]; dst.i[15:0] = src0.i[15:0] * src1.i[15:0] + src2.i[15:0] |
| `v_pk_add_i16 dst, src0, src1` | dst[31:16] = src0.i[31:16] + src1.i[31:16]; dst.i[15:0] = src0.i[15:0] + src1.i[15:0] |
| `v_pk_sub_i16 dst, src0, src1` | dst[31:16] = src0.i[31:16] - src1.i[31:16]; dst.i[15:0] = src0.i[15:0] - src1.i[15:0] |
